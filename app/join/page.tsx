          ...
          <div className="glass-card p-8 lg:p-12">
            {submitted ? (
              <div className="text-center py-12">
                ...
                <h2 className="text-2xl font-light text-[#7affd4] mb-4">
                  Thank You for Joining!
                </h2>
                <p className="font-extralight text-[#f5f5f0]/80 mb-8">
              ...
              <>
                ...
                <p className="font-extralight text-[#0a1128]/70 mb-8 text-sm">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="firstName" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl font-extralight text-[#0a1128] placeholder-[#0a1128]/40 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-all duration-200"
                        placeholder="First name"
                      />
                    </div>
                    <div>
                      <label htmlFor="lastName" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                        And your last name? *
                      </label>
                      <input
                        type="text"
                  ...
                  <div>
                    <label htmlFor="email" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                      What is your email address? *
                    </label>
                    <p className="text-xs font-extralight text-[#0a1128]/60 mb-2">So we can get in touch with you</p>
                    <input
                      type="email"
                      id="email"
                      name="email"
                  ...
                  {/* Company Information */}
                  <div>
                    <label htmlFor="companyName" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                      What's your company's name? *
                    </label>
                    <p className="text-xs font-extralight text-[#0a1128]/60 mb-2">If you don't have one, write TBC</p>
                    <input
                      type="text"
                      id="companyName"
                      name="companyName"
                  ...
                  <div>
                    <label htmlFor="companyWebsite" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                      If you have a website, share the link here:
                    </label>
                    <p className="text-xs font-extralight text-[#0a1128]/60 mb-2">Leave blank if you do not have a website. Please only enter links.</p>
                    <input
                      type="url"
                      id="companyWebsite"
                      name="companyWebsite"
                  ...
                  <div>
                    <label htmlFor="companyLocation" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                  ...
                  {/* Problem & Vision */}
                  <div>
                    <label htmlFor="problemSolving" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                      Let's talk about your idea. What problem is your company solving? *
                    </label>
                    <p className="text-xs font-extralight text-[#0a1128]/60 mb-2">In less than 100 words</p>
                    <textarea
                      id="problemSolving"
                      name="problemSolving"
                      required
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl font-extralight text-[#0a1128] placeholder-[#0a1128]/40 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-all duration-200 resize-none"
                      placeholder="Describe the problem you're solving..."
                    />
                  </div>

                  <div>
                    <label htmlFor="companyVision" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                  ...
                  <div>
                    <label htmlFor="tractionProgress" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                      What traction / progress have you made so far towards this vision? *
                    </label>
                    <p className="text-xs font-extralight text-[#0a1128]/60 mb-2">Eg: product, customers, revenue, funds raised</p>
                    <textarea
                      id="tractionProgress"
                  ...
                  {/* Team Information */}
                  <div>
                    <label htmlFor="teamInfo" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                      What should we know about you and your team? *
                    </label>
                    <p className="text-xs font-extralight text-[#0a1128]/60 mb-2">Again, in less than 100 words</p>
                    <textarea
                      id="teamInfo"
                      name="teamInfo"
                      required
                  ...
                  <div>
                    <label htmlFor="linkedinUrl" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                  ...
                  <div>
                    <label htmlFor="additionalMaterials" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                      If you have additional materials to help us make a better decision, share the link here:
                    </label>
                    <p className="text-xs font-extralight text-[#0a1128]/60 mb-2">This could include a pitch deck or other supporting documents (Google Drive, Dropbox, etc.)</p>
                    <input
                      type="url"
                  ...
                  <div>
                    <label htmlFor="foundingTeamMakeup" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                      Founding team makeup *
                    </label>
                    <p className="text-xs font-extralight text-[#0a1128]/60 mb-2">Which of the following most accurately describes the founding team gender(s)?</p>
                    <select
                  ...
                  <div>
                    <label htmlFor="ceoGender" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                      CEO Gender *
                    </label>
                    <select
                      id="ceoGender"
                  ...
                  <div>
                    <label htmlFor="howDidYouHear" className="block text-sm font-light text-[#0a1128]/90 mb-2">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      />
                      <label htmlFor="joinNewsletter" className="ml-3 text-sm font-light text-[#0a1128]/80">
                    ...
                    <div className="flex items-start">
                      <input
                        ...
                        className="mt-1 h-4 w-4 rounded border-gray-300 text-gray-900 focus:ring-gray-900"
                      />
                      <label htmlFor="privacyAcknowledged" className="ml-3 text-sm font-light text-[#0a1128]/80">
