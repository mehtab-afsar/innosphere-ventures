                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-4">
                      <a href={leader.linkedin} className="p-2 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                        <Linkedin className="w-5 h-5 text-[#f5f5f0]/70 hover:text-[#f5f5f0]" strokeWidth={1.5} />
                      </a>
                      <a href={leader.twitter} className="p-2 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                        <Twitter className="w-5 h-5 text-[#f5f5f0]/70 hover:text-[#f5f5f0]" strokeWidth={1.5} />
                      </a>
                      <a href={`mailto:${leader.email}`} className="p-2 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                        <Mail className="w-5 h-5 text-[#f5f5f0]/70 hover:text-[#f5f5f0]" strokeWidth={1.5} />
                      </a>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-[#ff6b5a] text-white hover:bg-[#ff6b5a]/90 font-light text-base group transition-all duration-300 hover:scale-105" asChild>
              <Link href="/join">
                Get in Touch
                <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="border-[#7affd4]/40 text-[#7affd4] font-light text-base hover:bg-[#7affd4]/10 transition-all duration-300 hover:border-[#7affd4]/60" asChild>
