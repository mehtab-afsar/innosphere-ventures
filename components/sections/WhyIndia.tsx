    ...
    <section id="why-india" className="py-32 px-6 lg:px-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-16 text-center">
          ...
          <Button size="sm" className="bg-white text-black hover:bg-white/90 font-medium text-sm">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          ...
          <div className="glass-card group hover:scale-[1.02] transition-all duration-500 hover:shadow-2xl hover:shadow-white/10 scroll-reveal">
            <div className="h-full flex flex-col justify-between p-8">
              ...
              <div className="text-center">
                <AnimatedCounter target={165000} suffix="+" className="text-8xl font-light text-white mb-4" />
                <p className="text-2xl font-light text-white mb-3">Startups</p>
          ...
          <div className="flex gap-4 justify-center">
            ...
            <div className="glass-card group hover:scale-[1.02] transition-all duration-500 hover:shadow-2xl hover:shadow-white/10 scroll-reveal flex-1 max-w-[200px]">
          ...
          <div className="glass-card group hover:scale-[1.02] transition-all duration-500 hover:shadow-2xl hover:shadow-white/10 scroll-reveal">
            <div className="h-full p-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-light text-white">Systemic Impact</h3>
              </div>
              <p className="text-base font-extralight text-white/60 leading-relaxed mb-4">
                Every investment creates ripples across the innovation ecosystem.
              </p>
              <div className="space-y-2 text-sm font-extralight text-white/40">
          ...
          <div className="glass-card group hover:scale-[1.02] transition-all duration-500 hover:shadow-2xl hover:shadow-white/10 scroll-reveal">
            <div className="h-full p-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-light text-white">Homegrown Innovation</h3>
              </div>
              <p className="text-base font-extralight text-white/60 leading-relaxed mb-4">
